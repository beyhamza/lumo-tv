...
**Avancement du sprint : 52 % de 60 points.** Le lot serveur est terminé et le socle
Android avec lui ; il ne reste que des écrans. La seule vraie inconnue était tranchée
dès le départ ([`adr/0009`](../adr/0009-m3u-film-detection.md)).
