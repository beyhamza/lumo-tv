...
enum class ErrorCode(val value: kotlin.String) {
    ...
    @Json(name = "VOD_ITEM_NOT_FOUND")
    VOD_ITEM_NOT_FOUND("VOD_ITEM_NOT_FOUND"),

    @Json(name = "SERIES_NOT_FOUND")
    SERIES_NOT_FOUND("SERIES_NOT_FOUND"),

    @Json(name = "EPISODE_NOT_FOUND")
