...
export type PlaybackProgress = components["schemas"]["PlaybackProgress"];
export type RecentChannel = components["schemas"]["RecentChannel"];
...
export type EpgProgramme = components["schemas"]["EpgProgramme"];
export type EpgProgrammeList = components["schemas"]["EpgProgrammeList"];
export type EpgImportStatus = components["schemas"]["EpgImportStatus"];
export type EpgAttemptStatus = components["schemas"]["EpgAttemptStatus"];
export type EpgMappingStatus = components["schemas"]["EpgMappingStatus"];
export type EpgChannelProgrammes = components["schemas"]["EpgChannelProgrammes"];
export type EpgGrid = components["schemas"]["EpgGrid"];
